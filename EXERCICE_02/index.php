...
<div class="container">
    ...
    <p>Trier par :
        ...
        <a href="index.php?column=birthdate&order=desc"> ge (croissant)</a> |
        <a href="index.php?column=birthdate&order=asc"> ge (décroissant)</a>
    </p>
    <br>
        ...
        <div class="col-md-7">
            <table class="table">
                ...
                <?php foreach($users as $user):
                    echo '<tr><td>'. $user['gender'] . '</td>';
                    echo '<td>'. $user['firstname']. '</td>';
                    echo '<td>'. $user['lastname']. '</td>';
                    echo '<td>'. $user['email']. '</td>';
                    echo '<td>'. DateTime::createFromFormat('Y-m-d', $user['birthdate'])->diff(new DateTime('now'))->y . 'ans</td></tr>';
                endforeach; ?>
                </tbody>
            </table>
        </div>
